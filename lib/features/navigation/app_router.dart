...
import 'package:nalliq/features/message/screens/chat_screen.dart';
...
class AppRouter {
  static final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: '/chat/:storeUserId',
        name: 'chat',
        builder: (context, state) {
          final extra = state.extra as Map<String, String>? ?? {};
          return ChatScreen(
            receiverEmail: extra['email'] ?? "0.0",
            receiverUserId: state.pathParameters['storeUserId']!,
            receiveruserName: extra['name'] ?? "0.0",
          );
        },
      ),
